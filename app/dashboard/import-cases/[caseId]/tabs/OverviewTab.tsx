...
export function OverviewTab({ importCase, agents }: OverviewTabProps) {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Field label="Importer TIN">
              <input
                ...
                onChange={(e) => updateField("importerTinNumber", e.target.value)}
                className={dashInputClass}
              />
            </Field>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Field label="Airway bill">
              <input
                ...
                onChange={(e) => updateField("airwayBillNumber", e.target.value)}
                className={dashInputClass}
              />
            </Field>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Field label="Invoice currency">
              <input
                ...
                onChange={(e) =>
                  updateField("invoiceCurrencyCode", e.target.value.toUpperCase())
                }
                placeholder="e.g. USD"
                maxLength={3}
                className={dashInputClass}
