...
export function HowItWorksPhase({
  ...
  useMotionValueEvent(scrollYProgress, "change", (progress) => {
    if (!isDesktop || clickLockRef.current || steps.length === 0) return;
  ...
  const trackMinHeight = isDesktop
    ? `${Math.max(steps.length, 1) * STEP_VH}vh`
    : undefined;
  ...
  return (
    ...
    >
      <div
        className={
          isDesktop
            ? "sticky top-[var(--landing-nav-offset,4.75rem)] py-8 lg:py-10"
            : "py-2"
        }
      >
        {!isDesktop ? (
          <div className="space-y-5 min-w-0">
            ...
            <div className="rounded-2xl border border-gray-100 bg-white/80 p-2 sm:p-3 shadow-sm">
              {stepList}
          ...
          <div className="grid grid-cols-[minmax(0,0.95fr)_auto_minmax(0,1.35fr)] gap-6 xl:gap-10 items-start">
            <div className="pt-4">
            ...
            <div
              className="flex flex-col items-center self-stretch pt-4 pb-8 px-2"
              aria-hidden
            >
