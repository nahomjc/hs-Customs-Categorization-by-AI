...
const highlights = [
  {
    ...
    description:
      "Clients see every stage — from upload to export , in real time.",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Push alerts when an order moves to parsing, classifying, or export ready.",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Track dozens of shipments at once with status badges and timelines.",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
            ...
            <div className="relative min-h-[420px] sm:min-h-[460px]">
              ...
              <div className="landing-glass-header relative flex items-center justify-between gap-4 px-4 sm:px-5 py-3">
                ...
                <nav className="hidden sm:flex items-center gap-1">
                  {["Dashboard", "Upload", "History", "Orders"].map(
                    (label, i) => (
                      <span
                        key={label}
