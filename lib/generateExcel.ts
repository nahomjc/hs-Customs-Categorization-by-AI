...
import { parseDocumentClassificationMeta } from "./documentClassificationMeta";
...
export async function generateCategorizedExcel(
  ...
  const groupedSheet = workbook.addWorksheet("Grouped by HS code", {
  ...
  styleHeader(groupedSheet.getRow(1));
